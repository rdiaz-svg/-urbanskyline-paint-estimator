...
function calc(){
  let marketSale=0,productionHours=0,primerHours=0;
  ...
  state.rooms.forEach(r=>{
    ...
    primerHours+=roomPrimerHours;
    roomBreakdown.push({name:r.name,total:workHours+roomPrimerHours,primer:roomPrimerHours,...h});
...
bindProject();bindMaterialSettings();renderRooms();renderColors();refreshAll();
