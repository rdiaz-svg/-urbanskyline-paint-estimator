...
function bindPhoneFormatting(){const e=$('phone');if(!e)return;e.value=formatUsPhone(e.value);e.oninput=()=>{const pos=e.selectionStart||e.value.length;e.value=formatUsPhone(e.value);state.project.phone=e.value;localStorage.setItem('uslPaintApp',JSON.stringify(state));showSaved()}}
