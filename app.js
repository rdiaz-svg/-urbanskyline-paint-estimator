...
bindProject();bindPhotoInputs();bindMaterialSettings();bindSubcontractor();renderRooms();renderCabinets();renderColors();refreshAll();renderWorkflow();if($('viewApprovedProposal'))$('viewApprovedProposal').onclick=viewApprovedProposal;
